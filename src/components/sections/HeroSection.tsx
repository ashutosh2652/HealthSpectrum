          ...
          >
            <div className="space-y-4">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-medical-title">Transform Your</span>
                <br />
                <span className="text-foreground">Medical Documents</span>
              </h1>

              <p className="text-xl text-muted-foreground leading-relaxed">
                Upload prescriptions, lab results, and medical reports to get
                instant AI-powered analysis, risk assessments, and personalized
                health insights you can understand.
              </p>
            </div>
            ...
            <div className="relative card-medical-glow backdrop-blur-2xl shadow-medical">
              ...
              <div className="space-y-6 relative z-10">
                <div className="flex items-center justify-between">
                  ...
                  <div className="status-normal animate-pulse-soft">Active</div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-muted/50 backdrop-blur-sm rounded-xl p-5 border border-warning/20">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="status-warning">Monitor</span>
                    </div>
                    <div className="w-full bg-secondary/50 rounded-full h-3">
                      <motion.div
                        initial={{ width: 0 }}
