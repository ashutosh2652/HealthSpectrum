...
import { AnalysisReport, ConditionDetected, MedicationMentioned, TestExplained, FutureRisk, Recommendation } from '@/pages/types/AnalysisReport'
...
const AnalysisReportPage: React.FC<AnalysisReportPageProps> = ({ reportId }) => {
  ...
  const getUrgencyColor = (urgency: string) => {
    switch (urgency) {
      case 'urgent': return 'bg-gradient-to-r from-red-500 to-red-600 text-white shadow-red-500/25';
      case 'soon': return 'bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-amber-500/25';
      case 'normal': return 'bg-gradient-to-r from-emerald-500 to-green-500 text-white shadow-emerald-500/25';
  ...
  const getConfidenceGradient = (score: number) => {
    if (score >= 80) return 'bg-gradient-to-r from-blue-500/20 to-blue-600/20 border-blue-500/30';
    if (score >= 60) return 'bg-gradient-to-r from-amber-500/20 to-orange-500/20 border-amber-500/30';
  ...
  const calculateOverallHealthScore = (report: AnalysisReport): number => {
    ...
    const avgConfidence = report.conditionsDetected.reduce((sum, condition) => sum + condition.confidenceScore, 0) / report.conditionsDetected.length;
    const riskFactor = report.futureRisks.length * 5;
    const urgentRecommendations = report.recommendations.filter(rec => rec.urgency === 'urgent').length * 10;
    
    return Math.max(10, 100 - riskFactor - urgentRecommendations - (100 - avgConfidence));
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-gray-300 text-lg font-medium">Analyzing your health data...</p>
          ...
          <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-400 text-lg">Comprehensive health insights from your medical documents</p>
              </div>
              <div className="text-right">
                <div className="text-sm text-gray-400 mb-1">Generated on</div>
                <div className="text-white font-medium">{new Date(report.createdAt).toLocaleDateString()}</div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Detected Conditions</h3>
                  <p className="text-gray-400">{report.conditionsDetected.length} conditions identified</p>
                </div>
              </div>
                ...
                {report.conditionsDetected.map((condition, index) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <h4 className="font-bold text-lg text-white">{condition.name}</h4>
                      <div className="text-right">
                        <div className="text-2xl font-bold text-white">{condition.confidenceScore}%</div>
                    ...
                    {condition.explanation && (
                      <p className="text-gray-300 mb-4 leading-relaxed">{condition.explanation}</p>
                    )}
                    
                    {condition.estimatedOnsetDate && (
                      <div className="flex items-center text-sm text-gray-400 mb-4">
                        <Calendar className="w-4 h-4 mr-2" />
                        <span>Estimated onset: {new Date(condition.estimatedOnsetDate).toLocaleDateString()}</span>
                      </div>
                    )}
                    ...
                    {condition.evidenceSnippets.length > 0 && (
                      <div className="border-t border-gray-700/50 pt-4 mt-4">
                        <div className="flex items-center mb-3">
                          ...
                          <span className="text-sm font-medium text-gray-300">Evidence Found</span>
                        </div>
                        {condition.evidenceSnippets.map((snippet, snippetIndex) => (
                          <div key={snippetIndex} className="bg-gray-800/50 rounded-lg p-3 mb-2 border border-gray-700/30">
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-xs font-medium text-blue-400">Page {snippet.page}</span>
                            </div>
                            <p className="text-sm text-gray-300 italic">"{snippet.text}"</p>
                          </div>
                        ))}
                      </div>
                    )}
                        ...
                        <div className="flex items-center space-x-2">
                          {condition.userFeedback.isValidated ? (
                            <>
                              ...
                              <span className="text-sm font-medium text-green-400">Validated by Healthcare Provider</span>
                            </>
                          ) : (
                            <>
                              <AlertCircle className="w-5 h-5 text-amber-500" />
                              <span className="text-sm font-medium text-amber-400">Pending Validation</span>
                            </>
                          )}
                        </div>
                        {condition.userFeedback.notes && (
                          <p className="text-sm text-gray-300 mt-2 bg-gray-800/30 rounded-lg p-3">{condition.userFeedback.notes}</p>
                        )}
                      </div>
                    )}
                  </motion.div>
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Timeline Analysis</h3>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs bg-blue-500/20 text-blue-400 px-2 py-1 rounded-full border border-blue-500/30">Symptom Report</span>
                    </div>
                    <p className="text-gray-300 mb-1">Patient reported headache episodes</p>
                    <p className="text-sm text-gray-500">Page 2 • Document Reference</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs bg-red-500/20 text-red-400 px-2 py-1 rounded-full border border-red-500/30">Vital Signs</span>
                    </div>
                    <p className="text-gray-300 mb-1">BP measured 145/95 mmHg</p>
                    <p className="text-sm text-gray-500">Page 3 • Elevated reading</p>
                  </div>
                </motion.div>
              </div>
            </motion.section>
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Current Medications</h3>
                  <p className="text-gray-400">{report.medicationsMentioned.length} medications identified</p>
                </div>
              </div>
                ...
                {report.medicationsMentioned.map((medication, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <h4 className="font-bold text-lg text-white">{medication.name}</h4>
                      <Pill className="w-5 h-5 text-green-400" />
                    </div>
                    {medication.dosage && (
                      <div className="mb-3">
                        <span className="text-sm text-gray-400">Dosage:</span>
                        <p className="text-blue-400 font-medium">{medication.dosage}</p>
                      </div>
                    )}
                    {medication.reason && (
                      <div>
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Diagnostic Tests</h3>
                  <p className="text-gray-400">Recommended and completed tests</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                {report.testsExplained.map((test, index) => (
                  ...
                  >
                    ...
                    {test.reason && (
                      <p className="text-gray-300 leading-relaxed">{test.reason}</p>
                    )}
                  </motion.div>
                ))}
              </div>
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Future Health Risks</h3>
                  <p className="text-gray-400">Potential health concerns to monitor</p>
                </div>
              </div>
                ...
                {report.futureRisks.map((risk, index) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="text-right">
                        <div className="text-xl font-bold text-white">{risk.confidenceScore}%</div>
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Personalized health recommendations</p>
                </div>
              </div>
                ...
                {report.recommendations.map((recommendation, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <p className="text-gray-300 flex-1 leading-relaxed pr-4">{recommendation.text}</p>
                      <motion.span 
          ...
          >
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-700/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
              <h3 className="text-lg font-semibold mb-6 text-center text-white">Overall Health Score</h3>
              <div className="text-center">
                <div className="relative w-32 h-32 mx-auto mb-4">
                  <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 120 120">
                    ...
                    <motion.circle
                      ...
                      animate={{ strokeDashoffset: 2 * Math.PI * 50 * (1 - overallHealthScore / 100) }}
                ...
                <div className={`text-lg font-semibold bg-gradient-to-r ${getHealthScoreColor(overallHealthScore)} bg-clip-text text-transparent`}>
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-700/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-lg font-semibold text-white">Key Entities</h3>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-2">
                    {report.medicationsMentioned.slice(0, 3).map((med, index) => (
                      <div key={index} className="flex items-center justify-between bg-gray-900/30 rounded-lg p-2">
                        <span className="text-sm text-blue-400 font-medium">{med.name}</span>
                        <span className="text-xs text-gray-500">{Math.floor(Math.random() * 20) + 80}%</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {report.conditionsDetected.slice(0, 3).map((condition, index) => (
                      <div key={index} className="flex items-center justify-between bg-gray-900/30 rounded-lg p-2">
                        <span className="text-sm text-blue-400 font-medium">{condition.name}</span>
                        <span className="text-xs text-gray-500">{condition.confidenceScore}%</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between bg-gray-900/30 rounded-lg p-2">
                      <span className="text-sm text-blue-400 font-medium">BP: 140/90</span>
                      <span className="text-xs text-gray-500">92%</span>
                    </div>
                    <div className="flex items-center justify-between bg-gray-900/30 rounded-lg p-2">
                      <span className="text-sm text-blue-400 font-medium">Cholesterol</span>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between bg-gray-900/30 rounded-lg p-2">
                      <span className="text-sm text-blue-400 font-medium">Headache</span>
                      <span className="text-xs text-gray-500">90%</span>
                    </div>
                    <div className="flex items-center justify-between bg-gray-900/30 rounded-lg p-2">
                      <span className="text-sm text-blue-400 font-medium">Fatigue</span>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between bg-gray-900/30 rounded-lg p-2">
                      <span className="text-sm text-blue-400 font-medium">2025-09-06</span>
          ...
          {showRawData && (
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white">Raw JSON Data</h3>
                  <p className="text-gray-400">Complete analysis report data structure</p>
                </div>
              </div>
              <div className="bg-gray-900/50 rounded-xl p-6 border border-gray-700/30">
