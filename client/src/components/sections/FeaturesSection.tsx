  ...
  return (
    <section className="medical-section bg-card/30">
      <div className="medical-container">
        ...
        >
          <h2 className="text-medical-title mb-4">
            Powerful Medical AI Features
          </h2>
          <p className="text-medical-body max-w-2xl mx-auto">
            Transform complex medical documents into clear, actionable health
            insights with our advanced AI technology.
          </p>
        </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Securely upload your medical documents, prescriptions, lab results, or health reports.",
                icon: FileText,
              },
              {
                step: "02",
                title: "AI Analysis",
                description:
                  "Our medical AI processes and analyzes your documents to extract key health insights.",
                icon: Brain,
              },
              {
                step: "03",
                title: "Get Results",
                description:
                  "Receive a comprehensive health report with recommendations and risk assessments.",
                icon: TrendingUp,
              },
            ].map((item, index) => (
              <motion.div
